    ...
    return(
        <ChakraProvider>
            ...
            <Box>
                ...
                <Stack marginTop="-70px" width="100%" height="100vh" justifyContent="center" alignItems="center">
                    <Box bg="blue.300" borderRadius="30px" d="flex" flexDirection="column" justifyContent="center" boxShadow="dark-lg" alignItems="center">
                        ...
                        <Box d="flex" justifyContent="center" alignItems="center">
                            <Text padding="10px" color="white" margin="5px" marginTop="10px" textAlign="center">Eu sou Kennedy Adelson Lopes, sou corretor crediciado na <a href="https://direcional.com.br/">Direcional.</a></Text>
                        </Box>
                        <Box marginBottom="10px">
                            <Button>Instagram</Button>
                            <Button marginLeft="5px">Whatsapp</Button>
                        </Box>
                    </Box>
                </Stack>
            </Box>
